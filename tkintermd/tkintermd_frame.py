...
class TkinterMDFrame(tk.Frame):
    ...
    def __init__(self, master, **kwargs):
        ...
        # self.code_inline_btn = tk.Button(self.top_bar, text="Code Inline")
        # self.code_inline_btn.pack(side="left", padx=0, pady=0)
        # self.code_block_btn = tk.Button(self.top_bar, text="Code Block")
        # self.code_block_btn.pack(side="left", padx=0, pady=0)
    ...
    def check_bold_italic(self, md_syntax, md_ignore, md_special=None):
        ...
        if str(self.cur_selection).startswith(self.md_ignore) or str(self.cur_selection).endswith(self.md_ignore):
            return
        elif isinstance(self.md_special, tuple):
            ...
            # nothing and return from the function.
            if str(self.cur_selection).startswith(self.md_special) and str(self.cur_selection).endswith(self.md_special) and not str(self.cur_selection).startswith(self.md_syntax) and not str(self.cur_selection).startswith(self.md_syntax):
                return
